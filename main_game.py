...
def mob_spawn():
    if area == 1:
        ...
        for mob in mob_list_area_1:
            if mob == mob_list_area_1[random_spawn]:
                current_mob = mob
    elif area == 2:
        random_spawn = random.randint(0,2)
        for mob_id in mob_list_area_2:
            if mob == mob_list_area_2[random_spawn]:
                current_mob = mob
    elif area == 3:
        random_spawn = random.randint(0,2)
        for mob_id in mob_list_area_3:
